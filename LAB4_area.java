...
class student
{
    public static void main(String args[]) {
        ...
        System.out.println("Enter the length and breadth to find the area of rectangle in cm\n");
        R1.length = A.nextInt();
        R1.breadth = A.nextInt();
        System.out.println("Enter the length and breadth to find the area of triangle in cm\n");
        T1.length = A.nextInt();
        T1.breadth = A.nextInt();
        System.out.println("Enter the radius to find the area of circle in cm\n");
        C1.length = A.nextInt();
        R1.printArea();
        T1.printArea();
        C1.printArea();
